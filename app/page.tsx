...
const feedbackSource: FeedbackItem[] = [
  ...
  {
    id: "inactive-camera",
    title: "Kamera Nonaktif dan Respons Terbatas",
    group: "Kelas Online",
    level: "attention",
    keywords: ["offcam", "kamera mati", "zoom", "respons"],
    variants: [
      "Selama kelas online, kamera {{firstname}} sering tidak aktif dan respons terhadap pertanyaan masih terbatas. Diharapkan ia dapat menggunakan suara, chat, atau bentuk interaksi lain yang disepakati agar keterlibatannya lebih mudah dipantau.",
      "Kamera {{firstname}} belum selalu aktif selama sesi Zoom dan ia masih jarang memberikan respons. Check-in singkat melalui mikrofon atau chat dapat membantu memastikan materi tetap diikuti dengan baik.",
    ],
  },
  {
    id: "camera-off-responsive",
    title: "Kamera Nonaktif tetapi Tetap Responsif",
    group: "Kelas Online",
    level: "positive",
    keywords: ["offcam", "kamera mati", "aktif", "zoom"],
    variants: [
      "Meskipun kamera {{firstname}} tidak selalu aktif selama kelas online, ia tetap memberikan respons melalui suara atau chat dan mampu mengikuti instruksi dengan baik.",
      "{{firstname}} beberapa kali mengikuti sesi Zoom tanpa kamera, tetapi tetap aktif menjawab, bertanya, dan menyelesaikan kegiatan yang diberikan. Keterlibatannya tetap terlihat positif.",
    ],
  },
  {
    id: "camera-microphone-issues",
    title: "Kendala Kamera atau Mikrofon",
    group: "Kelas Online",
    level: "technical",
    keywords: ["kamera", "mikrofon", "mic", "audio", "zoom"],
    variants: [
      "{{firstname}} beberapa kali mengalami kendala pada kamera atau mikrofon selama kelas online. Pemeriksaan perangkat sebelum kelas dapat membantu mengurangi hambatan saat berdiskusi dan melakukan praktik.",
      "Partisipasi {{firstname}} sempat terhambat karena kamera atau audio tidak berfungsi dengan baik. Menyiapkan perangkat lebih awal dan memiliki cara respons cadangan melalui chat akan membantu menjaga keterlibatan.",
    ],
  },
  {
    id: "active-via-chat",
    title: "Aktif Berpartisipasi Melalui Chat",
    group: "Kelas Online",
    level: "positive",
    keywords: ["chat", "zoom", "tidak bicara", "respons tertulis"],
    variants: [
      "{{firstname}} cukup aktif menyampaikan jawaban dan pertanyaan melalui chat selama kelas online. Cara berpartisipasi ini menunjukkan bahwa ia tetap mengikuti pembelajaran dengan baik.",
      "Walaupun belum sering menggunakan mikrofon, {{firstname}} konsisten merespons melalui chat dan terlibat dalam kegiatan kelas. Pertahankan partisipasi positif ini sambil membangun kenyamanan berbicara secara bertahap.",
    ],
  },
  {
    id: "unstable-online-session",
    title: "Sering Keluar-Masuk Sesi Online",
    group: "Kelas Online",
    level: "technical",
    keywords: ["keluar masuk", "disconnect", "terputus", "zoom", "koneksi"],
    variants: [
      "{{firstname}} beberapa kali terputus dan harus masuk kembali ke sesi online sehingga ada bagian materi yang terlewat. Menyiapkan koneksi cadangan atau meninjau materi setelah kelas dapat membantu menjaga kesinambungan belajar.",
      "Koneksi yang tidak stabil membuat {{firstname}} beberapa kali keluar-masuk sesi Zoom. Catatan materi dan kesempatan melakukan konfirmasi setelah tersambung kembali akan membantu mengurangi ketertinggalan.",
    ],
  },
  {
    id: "late-online-class",
    title: "Terlambat Bergabung ke Kelas Online",
    group: "Kelas Online",
    level: "attention",
    keywords: ["telat zoom", "terlambat masuk", "join", "online"],
    variants: [
      "{{firstname}} masih beberapa kali terlambat bergabung ke kelas online. Masuk beberapa menit sebelum kelas dimulai akan membantu memastikan perangkat, suara, dan koneksi sudah siap.",
      "Saat sudah bergabung, {{firstname}} dapat mengikuti pembelajaran dengan cukup baik. Namun, kebiasaan masuk terlambat perlu diperbaiki agar instruksi awal dan penjelasan penting tidak terlewat.",
    ],
  },
  {
    id: "screen-sharing-difficulty",
    title: "Kesulitan Berbagi Layar",
    group: "Kelas Online",
    level: "technical",
    keywords: ["share screen", "berbagi layar", "presentasi", "zoom"],
    variants: [
      "{{firstname}} sudah berusaha mengikuti kegiatan praktik, tetapi masih mengalami kesulitan saat membagikan layar. Latihan singkat menggunakan fitur berbagi layar sebelum kelas dapat membantu proses pendampingan berjalan lebih lancar.",
      "Saat diminta menunjukkan hasil pekerjaan, {{firstname}} masih memerlukan bantuan untuk menggunakan fitur berbagi layar. Panduan langkah singkat akan membantunya lebih mandiri pada sesi berikutnya.",
    ],
  },
  {
    id: "online-focus",
    title: "Fokus Selama Kelas Online Perlu Ditingkatkan",
    group: "Kelas Online",
    level: "growth",
    keywords: ["tidak respons", "terdistraksi", "zoom", "fokus online"],
    variants: [
      "{{firstname}} hadir dalam sesi online, tetapi beberapa kali tidak memberikan respons ketika dipanggil atau saat instruksi diberikan. Check-in singkat dan respons melalui chat dapat membantu menjaga keterlibatan selama kelas.",
      "Fokus {{firstname}} selama kelas online masih perlu ditingkatkan. Menyiapkan tempat belajar yang minim gangguan dan memberi respons pada setiap tahapan kegiatan akan membantu proses belajar lebih optimal.",
    ],
  },
  {
    id: "good-online-etiquette",
    title: "Etika Kelas Online Sangat Baik",
    group: "Kelas Online",
    level: "positive",
    keywords: ["etika", "zoom", "mute", "sopan", "tepat waktu"],
    variants: [
      "{{firstname}} menunjukkan sikap yang baik selama kelas online dengan bergabung tepat waktu, menggunakan fitur chat secara relevan, dan memberi kesempatan kepada teman untuk berbicara.",
      "Selama sesi daring, {{firstname}} berkomunikasi dengan sopan, menggunakan mikrofon pada waktu yang tepat, dan mengikuti arahan kelas dengan tertib. Etika digital ini patut dipertahankan.",
    ],
  },
  {
    id: "rapid-growth",
...
const englishContent: Record<string, [title: string, action: string]> = {
  ...
  "inactive-camera": ["Camera Off and Limited Responses", "Encourage responses through voice, chat, or another agreed method so participation remains visible."],
  "camera-off-responsive": ["Responsive Participation with Camera Off", "Recognize consistent responses through voice or chat without treating camera use as the only sign of engagement."],
  "camera-microphone-issues": ["Camera or Microphone Issues", "Check the device before class and keep chat available as a backup way to participate."],
  "active-via-chat": ["Active Participation Through Chat", "Maintain this written participation while gradually building comfort with other forms of interaction."],
  "unstable-online-session": ["Repeated Disconnections from Online Sessions", "Use a backup connection where possible and review any material missed after reconnecting."],
  "late-online-class": ["Late Arrival to Online Classes", "Join a few minutes early to check the device, audio, and connection before the lesson begins."],
  "screen-sharing-difficulty": ["Difficulty Sharing the Screen", "Practice the screen-sharing steps before class and keep a short guide available for support."],
  "online-focus": ["Sustaining Focus During Online Classes", "Use brief check-ins, chat responses, and a low-distraction workspace to support engagement."],
  "good-online-etiquette": ["Strong Online-Class Etiquette", "Continue joining on time, communicating respectfully, and using online-class tools appropriately."],
